	...
	<head>
		...
		<script>
			...
			function initialize(){
				...
				let st = document.getElementById("stock");
				st.value=3;
				if(st.value<=0){
					element.value=0;
					...
					<div class="detail-background">
						<article class="product-detail">
							<figure class="img-detail-page">
								<img src="../pictures/dove.jpeg" class="detail-img">
							</figure>
								<div class="details">
									<h1 class="detail-name">Dove body wash</h1>
									<h2 class="detail-price">RM25.00/pic</h2>
									<br><br>
									...
									<select name="variation">
										...
										<option>Sensitive body</option>
										<option>Soft body</option>
									</select>
									<br><br><br>
