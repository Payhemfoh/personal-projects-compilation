					...
					<div class="detail-background">
						<article class="product-detail">
							<figure class="img-detail-page">
								<img src="../pictures/cadbury.png" class="detail-img">
							</figure>
								<div class="details">
									<h1 class="detail-name">Cadbury Chocolate</h1>
									<h2 class="detail-price">RM12.00/pic</h2>
									<br><br>
									...
									<select name="variation">
										...
										<option>Strawberry Chocolate</option>
									</select>
									<br><br><br>
