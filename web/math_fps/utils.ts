...
function getIntersection(A:Coor, B:Coor, C:Coor, D:Coor):Intersection | null{
    /*
    ...
    */
    ...
    const uTop = ((B.y-A.y)*(C.x-A.x)) + ((A.y - C.y)*(B.x-A.x))
...
function polysIntersect(poly1:Coor[],poly2:Coor[]):boolean{
...
function getInter2(A:Coor,B:Coor,C:Coor,D:Coor):Intersection|null{
    /*
