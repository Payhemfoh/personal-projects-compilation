...
public class Week10_Lab1
{
    ...
    public static void saveToFile(String[] artist,String[] title,int[] price) throws IOException{
        FileWriter fw = new FileWriter("cd.txt");
        ...
        //make sure the file is closed or the text cannot saved into the file
        pw.close();
    }
}
